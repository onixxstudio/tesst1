...
const News = () => {
    ...
    return (
        <div id="news-container" className="center column w-[99vw] overflow-hidden">
            ...
            <div className="row">
                ...
                <p className="news-small-heading text-3xl">What media Says</p>
            </div>
            <h2>
                <div className="anim">
                    <div >Spread</div>
                ...
                <div className="anim">
                    <div ref={heading1} className='text-3xl text-black'>the News</div>
                </div>
            </h2>
